...
export const Header: React.FC<HeaderProps> = ({ scanResult, onRefresh, isScanning }) => {
  const appVersion = packageJson.version || '1.1.9';
    ...
    <header className="glass-panel app-header">
      <div className="header-brand">
        ...
        <div>
          <h1 className="brand-title">
            LinuxFS Manager{' '}
            <span style={{ fontSize: '0.78rem', color: 'var(--accent-light)', background: 'var(--accent-subtle)', padding: '2px 7px', borderRadius: 4, marginLeft: 6 }}>
              v{appVersion}
            </span>
          </h1>
      ...
      <div className="header-meta">
        ...
        <div className="badge badge-cyan">
          ...
          <Cpu size={13} />
          <span>Native Win32 Engine (Standalone)</span>
        </div>
        ...
        <div className="badge badge-violet mono">v{appVersion}</div>
      </div>
    </header>
  );
};
